      ...
      <div className="px-3 py-2">
        <div className="flex gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] font-medium text-textSecondary">Fullstack Developer</p>
          </div>
        </div>
        <p className="text-sm text-[#EAEAEA] py-3">
          Saya sangat senang Karena telah selesai membuat sebuah website sistem kelola barang
          menggunakan php dengan fitur crud
        </p>
