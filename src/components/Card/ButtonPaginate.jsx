...
const ButtonPaginate = ({ onPaginateExtend, loadingPaginate, current_page, last_page, loading }) => {
  ...
  return current_page === last_page || last_page === 1 || loading ? null :
      ...
      >
       {loadingPaginate ? <ImSpinner2 className="text-center w-6 h-6 text-white animate-spin" /> : 'See More'}
      </button>
