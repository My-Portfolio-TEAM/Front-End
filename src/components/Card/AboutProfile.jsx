    ...
    <section className="px-3 py-5 mt-3 sm:px-5 sm:mt-5 lg:px-10 bg-eerieBlack sm:rounded-xl">
      ...
      <div className="flex flex-col gap-8 py-5 lg:gap-10 2xl:flex-row">
        <p className="text-sm text-justify text-textSecondary whitespace-pre-wrap leading-[25px]">
         {
            myProfile === null || myProfile.biodata === null || myProfile.biodata.about === null ? 'There is nothing about yourself yet, please add about yourself' : myProfile.biodata.about
         }
        </p>
      ...
      {showModal && <EditAboutProfileModal myProfile={myProfile} openModal={showModal} setOpenModal={setShowModal} />}
    </section>
  );
}
