...
export default function MostActiveUsersProfile({
  userProfile,
  children,
  loading,
}) {
  ...
  return (
    <article className={`pb-5 w-full sm:rounded-xl bg-eerieBlack border`}>
      <img
        src={userProfile.background_photo === null ? bgCardProfile : userProfile.background_photo.background_photo}
        alt="bg card"
      ...
      <div className="flex flex-col px-2 sm:px-4">
        <div className="flex gap-2 mb-2 h-fit">
          <img
           src={userProfile.photo_profile === null ? placeholderPhotoProfile : userProfile.photo_profile.photo_profile}
          ...
          <div className="flex flex-col pt-1">
            ...
            <p className="text-[10px] font-medium text-textSecondary">{userProfile.biodata === null ? ''  : userProfile.biodata.role}</p>
          </div>
        </div>
