	...
	return (
		<div className='flex flex-col items-center justify-center h-screen gap-2'>
			...
			<p className='mt-5 mb-10 text-base font-medium text-center sm:text-lg text-textSecondary'>
				Uh oh, we can’t seem to find the page you’re <br/> looking for. Try going back to
				the previous page
			</p>
			<Link to='/'>
				<Button size='md' className='w-40 font-medium bg-fernGreen text-textPrimary'>Go to your home</Button>
			</Link>
		</div>
	);
}
